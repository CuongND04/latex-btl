...
\begin{itemize}[label=\textbullet]
    \item \textbf{Kiến trúc 3 lớp:} Hệ thống tách thành tầng Edge (ESP32 + cảm biến + relay + LCD), tầng xử lý trung tâm trên Cloud (MQTT Broker và dịch vụ xử lý dữ liệu), và tầng giám sát Dashboard để người dùng theo dõi và điều khiển từ xa.
